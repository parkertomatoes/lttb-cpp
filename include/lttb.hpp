...
template <typename InputIt, typename OutputIt, typename TPoint, typename TData, TData TPoint::*x, TData TPoint::*y>
void LargestTriangleThreeBuckets(InputIt source, size_t sourceSize, OutputIt destination, size_t destinationSize)
{
